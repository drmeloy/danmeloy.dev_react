    ...
    <>
      <section className={styles.Background}>
        ...
        <div className={styles.Backgrounds}>
          ...
          <p className={styles.Background}>I&apos;ve been a leader and facilitator for a wilderness non-profit. I led backcountry wilderness trips for adults with physical and developmental disabilities and facilitated outdoor experiential education events for under-served student communities. By helping people connect with the outdoors I was helping them build their confidence and realize that they can do anything they set their minds to, regardless of personal background or ability level.</p>
        </div>
      </section>
    </>
  );
