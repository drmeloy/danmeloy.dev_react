  ...
  return (
    <Element id='Background' name='Background'>
      <section className={styles.Background}>
        ...
        <p className={styles.Closer}>Now, as a developer and engineer, I use technology to apply the lessons I&apos;ve learned throughout my life. I aim to solve problems that empower others.</p>
      </section>
      <section className={mobile.Background}>
        <p className={mobile.Title}>A bit about my background...</p>
        <p className={mobile.Blurb}>Expand the sections below to learn about my approach to life and work:</p>
        <div className={mobile.Excerpts}>
          ...
          <details className={mobile.Detail}>
            ...
            <p className={mobile.Excerpt}>I&apos;ve opened two successful businesses Quito, Ecuador. Being a co-owner and founder of <a href='https://communityhostel.com/' target='_blank' rel='noopener noreferrer'>Community Hostel</a> and <a href='http://bandidobrewing.com/en/' target='_blank' rel='noopener noreferrer'>Bandido Brewing</a> taught me how to take ideas and turn them into reality. The challenges of opening two businesses in a foreign country taught me the value of adaptability. With a mindset of adaptability, any problem is solvable, any issue or interruption is merely a part of the process. To this day my adaptability remains one of my greatest strengths.</p>
          </details>
          <details className={mobile.Detail}>
        ...
        <p className={mobile.Closer}>Now, as a developer and engineer, I use technology to apply the lessons I&apos;ve learned throughout my life. I aim to solve problems that empower others.</p>
      </section>
    </Element>
  );
}
